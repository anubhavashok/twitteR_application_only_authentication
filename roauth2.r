...
searchTwitter<-
function(q,n=10,bearerToken){

curl.opts<-curlOptions(httpheader = c(  Authorization = paste("Bearer ",bearerToken,sep="")),
			verbose = TRUE
		)

#use getForm to get results, uri = generated by params, .opts=curl.opts
}
